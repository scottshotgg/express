...
int main() {
  ...
  std::string arizona = "iced out boys";
  int zero = 0;
  int one = 1;
  std::string ayy = "ayy";
...

  {
    ...
    int index = 0;
    int index_1532545221 = 0;
    while (index_1532545221 < 3) {
      {
        index = index_1532545221;
        i = index;
      }
      index_1532545221 += 1;
    }
  ...
  {
    int step = 0;
    int step_1532545221 = 0;
    while (step_1532545221 < 8) {
      {
        step = countdown[step_1532545221];
